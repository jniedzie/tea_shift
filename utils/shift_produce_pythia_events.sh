...
output_path="/nfs/dust/cms/user/jniedzie/shift/pythia_test_events/"
...
$python_path $user_base_path/shift_produce_pythia_events.py --part $1 --n_events $2 --m_z_prime $3 --m_dark_hadron $4 --m_dark_quark $5 --lifetime $6 --output_path $output_path --base_pythia_card $base_pythia_card --pythia_exec $pythia_exec_path
