...
if colliderMode:
  processes = [
    process.replace("pythia_", "pythiaCollider_") for process in processes
  ]
...
crossSections = {
  ...
  # HV: 60/5/1/X
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1em5":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1em3":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1em1":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1e0":
  reference_signal_cross_section * 1e4,
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1e1":
  reference_signal_cross_section * 1e5,
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1e3":
  reference_signal_cross_section * 1e9,
  "pythia_mZprime-60_mDH-5_mDQ-1_ctau-1e5":
  reference_signal_cross_section * 1e11,

  # HV: 60/20/1/X
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1em7":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1em5":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1em3":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1em1":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1e0":
  reference_signal_cross_section * 1e2,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1e1":
  reference_signal_cross_section * 1e5,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1e3":
  reference_signal_cross_section * 1e7,
  "pythia_mZprime-60_mDH-20_mDQ-1_ctau-1e5":
  reference_signal_cross_section * 1e9,
  ...
  reference_signal_cross_section * 1e8,
  "pythia_mZprime-15_mDH-5_mDQ-1_ctau-1e3":
  reference_signal_cross_section * 1e9,
...
if "shift" in variant:
  detectorParams = {
    ...
    "y":
    -1,  # -1 means it will be placed on the LHC ring (based on the z coordinate)
  ...
  detectorParams = {
    ...
    "length": 1.5,
    "maxEta":
    999999,  # there's no hole in the detector, so we can set this to a very high value
  }
elif "cms" in variant:
  detectorParams = {
    "x": 0,
